...
const CVLicenseCertificateRouter = new koa_router_1.default({
...
CVLicenseCertificateRouter.get("/:users_id", (ctx, next) => __awaiter(void 0, void 0, void 0, function* () {
...
CVLicenseCertificateRouter.post("/", (ctx, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
CVLicenseCertificateRouter.del("/:id", (ctx, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = ctx.params;
        const licenseCertificate = yield prisma.cVLicenseCertificate.findFirst({
            where: { id },
...
exports.default = CVLicenseCertificateRouter;
