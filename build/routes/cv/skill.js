...
const CVSkillRouter = new koa_router_1.default({ prefix: "/api/cv/skill" });
CVSkillRouter.get("/:users_id", (ctx, next) => __awaiter(void 0, void 0, void 0, function* () {
...
CVSkillRouter.post("/", (ctx, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
CVSkillRouter.del("/:id", (ctx, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = ctx.params;
