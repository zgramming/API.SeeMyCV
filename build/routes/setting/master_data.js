...
const MasterDataRouter = new koa_router_1.default({
    prefix: "/api/setting/master_data",
});
MasterDataRouter.get("/", (ctx, next) => __awaiter(void 0, void 0, void 0, function* () {
...
MasterDataRouter.post("/", (ctx, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
MasterDataRouter.put("/:id", (ctx, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
MasterDataRouter.del("/:id", (ctx, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id = 0 } = ctx.params;
        if (id == 0)
